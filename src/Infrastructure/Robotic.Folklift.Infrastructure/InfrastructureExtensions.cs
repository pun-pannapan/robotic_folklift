...
using Robotic.Folklift.Application.Services;
using Robotic.Folklift.Infrastructure.Data;
using Robotic.Folklift.Infrastructure.Services;
using System.Text;

namespace Robotic.Folklift.Infrastructure
{
    public static class InfrastructureExtensions
    {
        public static IServiceCollection AddFolkliftInfrastructure(this IServiceCollection services, IConfiguration cfg)
        {
            ...
            {
                swaggerService.SwaggerDoc("v1", new OpenApiInfo { Title = "Folklift API", Version = "v1" });
